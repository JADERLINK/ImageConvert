...
namespace __From_GNF_To_PNG__GFDLibrary__DDSReaderSharp_
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("__From_GNF_To_PNG__GFDLibrary__DDSReaderSharp_");
        ...
        static void Action(string file)
        {
            ...
            var bitmap = DDSReaderSharp.ToBitmap(ms.ToArray());
            ms.Close();

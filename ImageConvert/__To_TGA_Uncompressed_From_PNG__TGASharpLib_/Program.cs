...
namespace __To_TGA_Uncompressed_From_PNG__TGASharpLib_
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("__To_TGA_Uncompressed_From_PNG__TGASharpLib_");
        ...
        static void Action(string file)
        {
            ...
            var tga = new TGASharpLib.TGA(bitmap);
            tga.Save(outputFile);
        }
    }
}
